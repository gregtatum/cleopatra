import { $Call, $ReadOnly, $Shape } from "utility-types";
...
import { Thread, SamplesTable, FrameTable, StackTable, FuncTable, RawMarkerTable, JsAllocationsTable, UnbalancedNativeAllocationsTable, BalancedNativeAllocationsTable, ResourceTable, Profile, ExtensionTable, CategoryList, JsTracerTable } from "../types/profile";
...
export function shallowCloneRawMarkerTable(markerTable: RawMarkerTable): RawMarkerTable {
  return {
    // Important!
    // If modifying this structure, please update all callers of this function to ensure
    // that they are pushing on correctly to the data structure. These pushes may not
 ...
 */
export const resourceTypes = (getResourceTypes() as $Exact<$ReadOnly<$Call<typeof getResourceTypes>>>);
