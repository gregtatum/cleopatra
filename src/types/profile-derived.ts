...
import { IndexIntoFuncTable, ThreadIndex, Pid, IndexIntoJsTracerEvents, IndexIntoCategoryList, CounterIndex } from "./profile";
...
export type CallNodeDisplayData = $Exact<$ReadOnly<{
  totalTime: string;
 ...
 */
export type CombinedTimingRows = Array<MarkerTiming | StackTiming> | Array<StackTiming>;
...
export type GlobalTrack = {readonly type: "process";readonly pid: Pid;readonly mainThreadIndex: ThreadIndex | null;} | {readonly type: "screenshots";readonly id: string;readonly threadIndex: ThreadIndex;} | {readonly type: "visual-progress";readonly id: string;} | {readonly type: "perceptual-visual-progress";readonly id: string;} | {readonly type: "contentful-visual-progress";readonly id: string;};

export type LocalTrack = {readonly type: "thread";readonly threadIndex: ThreadIndex;} | {readonly type: "network";readonly threadIndex: ThreadIndex;} | {readonly type: "memory";readonly counterIndex: CounterIndex;} | {readonly type: "ipc";readonly threadIndex: ThreadIndex;};
 ...
 */
export type ActiveTabGlobalTrack = {readonly type: "tab";readonly threadIndex: ThreadIndex;} | {readonly type: "screenshots";readonly id: string;readonly threadIndex: ThreadIndex;};
 ...
 * timeline.
 */
export type SelectedState = // Samples can be filtered through various operations, like searching, or
// call tree transforms.
"FILTERED_OUT_BY_TRANSFORM" // Samples can be filtered out if they are not part of the active tab.
| "FILTERED_OUT_BY_ACTIVE_TAB" // This sample is selected because either the tip or an ancestor call node matches
// the currently selected call node.
| "SELECTED" // This call node is not selected, and the stacks are ordered before the selected
// call node as sorted by the getTreeOrderComparator.
| "UNSELECTED_ORDERED_BEFORE_SELECTED" // This call node is not selected, and the stacks are ordered after the selected
// call node as sorted by the getTreeOrderComparator.
