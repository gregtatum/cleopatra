...
import { Lib, IndexIntoStringTable, IndexIntoCategoryList, PausedRange, CategoryList, PageList, JsTracerTable, ProfilerOverheadStats, VisualMetrics, ProfilerConfiguration } from "./profile";
import { MarkerPayload_Gecko } from "./markers";
...
export type GeckoMarkers = {
  ...
  data: Array<[IndexIntoStringTable, Milliseconds, IndexIntoCategoryList, MarkerPayload_Gecko]>;
};
...
export type GeckoSamples = {
  ...
  data: Array<[null | IndexIntoGeckoStackTable, Milliseconds, // since profile.meta.startTime
...
export type GeckoSampleStruct = GeckoSampleStructWithResponsiveness | GeckoSampleStructWithEventDelay;
...
export type GeckoFrameTable = {
  ...
  data: Array<[// index into stringTable, points to strings like:
  // JS: "Startup::XRE_Main"
  // C++: "0x7fff7d962da1"
  IndexIntoStringTable, // for label frames, whether this frame should be shown in "JS only" stacks
  boolean, // innerWindowID of JS frames. See the comment inside FrameTable in src/types/profile.js
  // for more information.
  null | number, // for JS frames, an index into the string table, usually "Baseline" or "Ion"
  null | IndexIntoStringTable, // JSON info about JIT optimizations.
  null | Object, // The line of code
  null | number, // The column of code
  null | number, // index into profile.meta.categories
  null | number, // index into profile.meta.categories[category].subcategories. Always non-null if category is non-null.
  null | number]>;
};
...
export type GeckoProfilerOverhead = {
  samples: {
    ...
    data: Array<[Nanoseconds, Nanoseconds, Nanoseconds, Nanoseconds, Nanoseconds]>;
  };
