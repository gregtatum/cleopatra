...
// functions.
type _Send = (arg0: "send", arg1: GAPayload) => void;
type _Exception = (arg0: "send", arg1: "exception", arg2: GAErrorPayload) => void;
export type GoogleAnalytics = _Send & _Exception;

export function sendAnalytics(payload: GAPayload) {
  const ga: GoogleAnalytics | null | undefined = self.ga;
  if (ga) {
    ga('send', payload);
  }
}
