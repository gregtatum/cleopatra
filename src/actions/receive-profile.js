...
export function finalizeProfileView(
  ...
  return async (dispatch, getState) => {
    ...
    if (selectedThreadIndex !== null && getShowTabOnly(getState()) !== null) {
      // TODO:
      dispatch(finalizeProfileViewForActiveTab(profile, selectedThreadIndex));
    } else {
      // TODO:
      dispatch(finalizeProfileViewForAdvanced(profile, selectedThreadIndex));
    }
 ...
 * TODO:
 */
export function finalizeProfileViewForAdvanced(
  profile: Profile,
 ...
 * TODO:
 */
export function finalizeProfileViewForActiveTab(
  profile: Profile,
...
export function recomputeProfileData(): ThunkAction<void> {
  return (dispatch, getState) => {
    ...
    if (getShowTabOnly(getState()) !== null) {
      // TODO:
      dispatch(finalizeProfileViewForActiveTab(profile, selectedThreadIndex));
    } else {
      // TODO:
